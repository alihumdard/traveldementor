        ...
        <div class="col-lg-6 col-xl-4 col-md-6 mb-4">
            <a href="{{ route('client.index') }}">
                <div class="card h-100" style="border-radius: 20px;">
                    <div class="own-card-padding card-body d-flex justify-content-between"
        ...
        <div class="col-lg-6 col-xl-4 col-md-6 mb-4">
            <a href="{{ route('hotel.index') }}">
                <div class="card h-100" style="border-radius: 20px;">
                    <div class="own-card-padding card-body d-flex justify-content-between">
                        <div>
                            <h5 class="font-weight-bold text-dark">Hotel Bookings</h5>
                            <h5 style="color:#452C88;">{{ $hotel_bookings }}</h5>
                        </div>
                        <div class="ms-3">
                            <svg width="50" height="50" viewBox="0 0 384 512">
                                <path fill="#452C88"
                                    d="M64 32C28.7 32 0 60.7 0 96v352c0 17.7 14.3 32 32 32s32-14.3 32-32V320h256v128c0 17.7 14.3 32 32 32s32-14.3 32-32V160c0-35.3-28.7-64-64-64H64z" />
                            </svg>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-6 col-xl-4 col-md-6 mb-4">
            <a href="{{ route('insurance.index') }}">
                <div class="card h-100" style="border-radius: 20px;">
                    <div class="own-card-padding card-body d-flex justify-content-between">
                        <div>
                            <h5 class="font-weight-bold text-dark">Insurance</h5>
                            <h5 style="color:#452C88;">{{ $insurances }}</h5>
                        </div>
                        <div class="ms-3">
                            <svg width="50" height="50" viewBox="0 0 512 512">
                                <path fill="#452C88"
                                    d="M256 0L32 96v144c0 123.5 82.3 237.4 201.5 278.5L256 512l22.5-6.5C397.7 477.4 480 363.5 480 240V96L256 0z" />
                            </svg>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-6 col-xl-4 col-md-6 mb-4">
            <a href="{{ route('ds.index') }}">
                <div class="card h-100" style="border-radius: 20px;">
                    <div class="own-card-padding card-body d-flex justify-content-between">
                        <div>
                            <h5 class="font-weight-bold text-dark">DS-160</h5>
                            <h5 style="color:#452C88;">{{ $ds160s }}</h5>
                        </div>
                        <div class="ms-3">
                            <svg width="50" height="50" viewBox="0 0 384 512">
                                <path fill="#452C88"
                                    d="M224 136V0H24C10.7 0 0 10.7 0 24v464c0 13.3 10.7 24 24 24h336c13.3 0 24-10.7 24-24V160H248c-13.3 0-24-10.7-24-24z" />
                            </svg>
                        </div>
                    </div>
                </div>
