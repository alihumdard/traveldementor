            ...
            <table class="table table-bordered" style="border: 1px solid #ddd; border-radius: 12px; overflow: hidden; background-color: #f9f9f9; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
              ...
              <tbody>
                <tr style="transition: all 0.3s;">
                  <td style="padding: 12px; color: #452c88; font-weight: bold;">Applicant D.O.B</td>
                ...
                <tr style="transition: all 0.3s;">
                  <td style="padding: 12px; color: #452c88; font-weight: bold;">Passport No.</td>
                  <td style="padding: 12px;" id="pass_no">loading</td>
                </tr>
                <tr style="background-color: #ffffff; transition: all 0.3s;">
                  <td style="padding: 12px; color: #452c88; font-weight: bold;">Passport Expiry</td>
                ...
                {{-- <tr style="background-color: #ffffff; transition: all 0.3s;">
                  <td style="padding: 12px; color: #452c88; font-weight: bold;">Visa Expiry</td>
