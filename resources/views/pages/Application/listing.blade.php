            ...
            <table id="qoute-table" class="display" style="width:100%">
              ...
              <tbody id="tableData">
                @foreach ($applications as $application)
                                  <tr id="app-{{ $application->id }}" class="
                          {{ ($application->passport_alert_count > 0 && $application->visa_alert_count > 0)
                      ? 'both-alert-row'
                      : ($application->passport_alert_count > 0
                        ? 'passport-alert-row'
                        : ($application->visa_alert_count > 0
                          ? 'visa-alert-row'
                          : '')) }}
                  ">
                                    ...
                                    <td>
                                      ...
                                      @if($application->passport_alert_count > 0)
                                        <i class="fas fa-passport text-warning ms-1" title="Passport Expiry Alert"></i>
                                      @endif

                                      @if($application->visa_alert_count > 0)
                                        <i class="fas fa-id-card text-danger ms-1" title="Visa Expiry Alert"></i>
                                      @endif
                                    </td>
