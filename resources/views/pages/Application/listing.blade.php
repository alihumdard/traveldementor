                ...
                <tr style="font-size: small;">
                  ...
                  <td class="">
                    <div class="d-flex my-auto">
                        ...
                        <a href="{{ route('application.add',['id' => $id]) }}" id="btn_edit_announcement" class="btn p-0">
                      ...
                      <button id="quoteDetail_btn" class="btn p-0 quoteDetail_view" data-toggle="modal"
                        data-target="#qoutedetail">
