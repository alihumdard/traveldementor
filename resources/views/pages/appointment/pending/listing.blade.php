              ...
              <tbody id="tableData">
                @foreach ($appointments as $appointment)
                  <tr style="font-size: small;">
                    ...
                    <td>{{ $appointment->client->contact_no ?? 'N/A' }}</td>
                    ...
                    <td class="">
                      <div class="d-flex my-auto">
                        ...
                        <!-- Quote Detail Button -->
                        <button data-id="{{ $appointment->id }}" id="pending_btn" class="btn p-0 quoteDetail_view"
    ...
    $(document).on('click', '#pending_btn', function () {
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          $("#name").val(response.detail_page.client.name + '~' + response.detail_page.client.sur_name); s
