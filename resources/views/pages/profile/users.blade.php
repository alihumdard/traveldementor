          ...
          <div class="col-lg-12">
            <div class="row mx-1">
              <div class="col-lg-9 col-sm-6 mb-1 pr-0" style="text-align: right;">
                <button class="btn add-btn text-white" data-toggle="modal" data-target="#addUsers" style="background-color: #452C88;"><span><i class="fa fa-plus"></i> @lang('lang.add_user')</span></button>
              </div>
