        ...
        <form id="formData" action="{{ route('settings', $user->id) }}" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 mt-3">
              <label class="mb-0" style="color: #452C88;"
                for="phone"><span><b>@lang('lang.phone_number')</b></span></label>
              <input type="text" class="form-control" value="{{$user->phone}}" name="phone" id="phone"
                placeholder="@lang('lang.enter_your_number')">
            </div>
            <div class="col-lg-4 col-sm-6 mt-3">
              <label class="mb-0" style="color: #452C88;"
                for="address"><span><b>@lang('lang.address')</b></span></label>
              <input type="text" class="form-control" value="{{$user->address}}" name="address" id="address"
                placeholder="@lang('lang.address')">
            </div>
            <div class="col-lg-4 col-sm-6 mt-3">
              <label class="mb-0" style="color: #452C88;"
                for="new_password"><span><b>@lang('lang.new_password')</b></span></label>
              <input type="password" class="form-control" name="password" id="password"
                placeholder="@lang('lang.enter_new_password')">
            </div>
            <div class="col-lg-4 col-sm-6 mt-3">
              <label class="mb-0" style="color: #452C88;"
                for="confirm_password"><span><b>@lang('lang.confirm_password')</b></span></label>
            ...
            <div class="col-lg-4 mt-3 my-4 text-right">
              <button class="btn text-white btn-md px-4" type="submit" name="update" onclick="validateForm(event)"
