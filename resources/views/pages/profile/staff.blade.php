            ...
            <table id="users-table" class="display" style="width:100%">
              ...
              <tbody id="tableData">
                ...
                <tr>
                  ...
                  <td><img
                      src="{{ (isset($value['user_pic'])) ? asset('storage/' . $value['user_pic']) : 'assets/images/user.png'}}"
                      style="width: 45px; height: 45px; border-radius: 38px; object-fit: cover;" alt="text"></td>
                  <td> {{ $value['name'] }} </td>
                  <td>{{ $value['email'] }}</td>
                  <td>{{ $value['phone'] }}</td>
                  @if($value['status'] == 1)
                    ...
                    <button class="btn btn_status">
                      <span data-user_id="{{$value['id']}}">
                        <div
                          ...
                          <div
                            style="text-align: center; color: #452C88; font-size: 14px; font-weight: 500; word-wrap: break-word">
                            @lang('lang.deleted')</div>
                        </div>
                      </span>
                    </button>
                  </td>
                  ...
                  <td style="min-width: 80px; max-width: fit-content;">
                    @if($value['status'] != 5)
                    <button id="btn_edit_user" class="btn p-0" data-user_id="{{$value['id']}}"
                      data-api_name="{{'users'}}">
